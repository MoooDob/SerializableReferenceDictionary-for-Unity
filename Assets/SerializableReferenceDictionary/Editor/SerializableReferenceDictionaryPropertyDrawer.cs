...
namespace SerializableReferenceDictionary
{
    ...
    [CustomPropertyDrawer(typeof(SerializableReferenceHashSetBase), true)]
#endif
    public class SerializableReferenceDictionaryPropertyDrawer : PropertyDrawer
    {
	    ...
	    static SerializableReferenceDictionaryPropertyDrawer()
	    {
    ...
    [CustomPropertyDrawer(typeof(SerializableReferenceDictionaryBase.Storage), true)]
    public class SerializableReferenceDictionaryStoragePropertyDrawer : PropertyDrawer
    {
	    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	    {
		    property.Next(true);
