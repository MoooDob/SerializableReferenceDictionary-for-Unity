...
namespace SerializableReferenceDictionary
{
    ...
    [Serializable]
    public abstract class SerializableReferenceDictionaryBase<TKey, TValue, TValueStorage> : SerializableReferenceDictionaryBase, IDictionary<TKey, TValue>, IDictionary, ISerializationCallbackReceiver, IDeserializationCallback, ISerializable
    {
    ...
    [Serializable]
    public static class SerializableReferenceDictionary
    {
        public class Storage<T> : SerializableReferenceDictionaryBase.Storage
        {
            public T data;
        }
    }
    ...
    [Serializable]
    public class SerializableReferenceDictionary<TKey, TValue, TValueStorage> : SerializableReferenceDictionaryBase<TKey, TValue, TValueStorage> where TValueStorage : SerializableReferenceDictionary.Storage<TValue>, new()
    {
        public SerializableReferenceDictionary() { }
        public SerializableReferenceDictionary(IDictionary<TKey, TValue> dict) : base(dict) { }
        protected SerializableReferenceDictionary(SerializationInfo info, StreamingContext context) : base(info, context) { }
