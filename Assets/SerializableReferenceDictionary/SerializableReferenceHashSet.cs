...
namespace SerializableReferenceDictionary
{
    ...
    public abstract class SerializableReferenceHashSetBase
    {
    ...
    [Serializable]
    public abstract class SerializableReferenceHashSet<T> : SerializableReferenceHashSetBase, ISet<T>, ISerializationCallbackReceiver, IDeserializationCallback, ISerializable
    {
        HashSet<T> m_hashSet;
        [SerializeField]
        T[] m_keys;

        public SerializableReferenceHashSet()
        {
            m_hashSet = new HashSet<T>();
        }

        public SerializableReferenceHashSet(ISet<T> set)
        {
        ...
        protected SerializableReferenceHashSet(SerializationInfo info, StreamingContext context)
        {
